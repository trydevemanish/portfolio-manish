...
export default function About() {
  ...
  <div className='flex flex-col-reverse gap-8 xs:flex-col-reverse sm:flex-col-reverse md:flex-row md:justify-between md:items-center'>

    {/* Left — text content, your existing code unchanged */}
    <div className='flex flex-col gap-6'>
      <h1 className='text-5xl sm:text-5xl font-bold inline-block xs:flex xs:flex-col sm:flex sm:flex-col sm:gap-4 2xl:text-6xl 3xl:text-6xl 4xl:text-6xl 5xl:text-7xl 6xl:text-7xl'>
        <span>Hi, {"I'm"} </span>
        <span className='text-cyan-400'>Manish Sharma.</span>
      </h1>
      <p className='text-base font-medium xs:text-base sm:text-xl sm:pt-4 md:text-xl lg:text-xl xl:text-xl 2xl:text-xl 3xl:text-xl 4xl:text-xl 5xl:text-3xl 6xl:text-3xl'>
        A Full-Stack Developer who loves to turn
      </p>
      <p className='text-sm xs:text-base sm:text-lg lg:text-lg xl:text-xl 2xl:text-xl 3xl:text-lg 4xl:text-xl 5xl:text-3xl 6xl:text-3xl'>
        <span className='pl-1 pb-1'>ideas </span>
        <span className='opacity-50'>into code.</span>
      ...
      <div className='flex gap-3 pt-3'>
        <Button className='text-lg rounded-xl py-4 px-6 hover:bg-zinc-700 xs:py-6 xs:text-base xs:px-6 sm:py-6 sm:px-6 sm:text-lg md:text-lg xl:text-lg lg:text-lg 2xl:text-xl 3xl:text-xl 4xl:text-xl md:px-6 lg:px-7 xl:px-7 2xl:px-7 3xl:px-7 4xl:px-7 md:py-6 lg:py-7 xl:py-7 2xl:py-7 3xl:py-7 4xl:py-7 5xl:px-9 5xl:py-9 5xl:text-3xl 6xl:px-9 6xl:py-9 6xl:text-3xl' variant='default'>
          <Link href='/projects'>Projects</Link>
        </Button>
        <Button className='text-xs pt-1 pb-1 pl-3 pr-3 hover:bg-zinc-700 rounded-xl xs:py-6 xs:text-base xs:px-6 sm:py-6 sm:px-6 sm:text-lg md:text-lg xl:text-lg lg:text-lg 2xl:text-xl 3xl:text-xl md:px-6 lg:px-7 xl:px-7 2xl:px-7 3xl:px-7 4xl:px-7 md:py-6 lg:py-7 xl:py-7 2xl:py-7 3xl:py-7 4xl:py-7 5xl:px-9 5xl:py-9 5xl:text-3xl 6xl:px-9 6xl:py-9 6xl:text-3xl'>
          <Link href='https://docs.google.com/document/d/1_mtnMOfXls6Bx0yFG8Ar6uoYQnHZuU8k6wHKTCIec40/edit?usp=sharing'>View Resume</Link>
        </Button>
      </div>
      <div className='flex items-center gap-2'>
        <Mail size={10} className='xs:w-3 xs:h-3 sm:w-3 sm:h-3 md:w-4 md:h-4 lg:w-4 lg:h-4 xl:w-4 xl:h-4 2xl:w-4 2xl:h-4 3xl:w-4 3xl:h-4 4xl:w-4 4xl:h-4 5xl:w-7 5xl:h-7 6xl:w-7 6xl:h-7' />
        <p className='text-cyan-400 text-[10px] xs:text-base sm:text-lg md:text-lg xl:text-lg lg:text-lg 2xl:text-xl 3xl:text-xl 4xl:text-xl 5xl:text-3xl 6xl:text-3xl'>
          manishvsharma1@gmail.com
        </p>
        {checkifEmailCopy === false
          ? <Copy size={10} className='cursor-pointer xs:w-3 xs:h-3 sm:w-2 sm:h-2 md:w-4 md:h-4 lg:w-4 lg:h-4 xl:w-4 xl:h-4 2xl:w-4 2xl:h-4 3xl:w-4 3xl:h-4 4xl:w-4 4xl:h-4 5xl:w-7 5xl:h-7 6xl:w-7 6xl:h-7' onClick={handlecopyButton} />
          : <CopyCheckIcon size={10} className='cursor-pointer xs:w-3 xs:h-3 sm:w-2 sm:h-2 md:w-4 md:h-4 lg:w-4 lg:h-4 xl:w-4 xl:h-4 2xl:w-4 2xl:h-4 3xl:w-4 3xl:h-4 4xl:w-4 4xl:h-4 5xl:w-7 5xl:h-7 6xl:w-7 6xl:h-7' onClick={() => setCheckIfEmailCopy(false)} />
        }
      </div>
    </div>

    {/* Right — image */}
    <div className='flex justify-center md:justify-end flex-shrink-0 pt-10 xs:pt-0 md:pr-12'>
  <div className='flex flex-col gap-1'>
    <Image
      src={Profile}
      alt='Manish Sharma'
      className='rounded-md object-cover hover:animate-in
        w-48 h-48
        xs:w-52 xs:h-52
        sm:w-64 sm:h-64
        md:w-64 md:h-64
        ...
        2xl:w-80 2xl:h-80
        5xl:w-96 5xl:h-96
        6xl:w-[28rem] 6xl:h-[28rem]'
    />
    <p className='bg-cyan-400 w-full h-[2px]' />
